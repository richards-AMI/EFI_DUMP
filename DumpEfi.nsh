...
#if NE %1 then
#    echo Need file Name - Project  ex.:    dumpefi.nsh  lb123
#   goto END
#endif
...
# EfiSce don't like sub-paths in output filename; do some workarounds
#	cd EfiDump_%1
#   FS%i:\EfiDump\SceEfi64.efi /o /s Setup_%1.txt /h hii /v
#	cp FS%i:\Setup_%1.txt FS%i:\EfiDump\EfiDump\EfiDump_%1\S#etup.txt
#	rm FS%i:\Setup_%1.txt
